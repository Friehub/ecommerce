...
export default function DisputeCenter() {
 ...
 <p className="text-[10px] font-semibold uppercase  text-on-surface-variant opacity-40 animate-pulse">Syncing Resolution Nodes</p>
 </div>
 </div>
 );
 }
 ...
 <h2 className="text-[10px] font-semibold text-jumia-orange uppercase ">Resolution Protocol</h2>
 </div>
 ...
 <p className="text-[10px] font-semibold text-on-surface-variant/40 uppercase  mt-4 italic">Operational conflict management and settlement tracking.</p>
 </div>
 <div className="flex items-center gap-4">
 <Link href="/orders" className="h-14 px-8 bg-surface-container-low text-on-surface rounded-xl font-semibold text-[10px] uppercase  hover:bg-jumia-orange hover:text-white transition-all active:scale-95 flex items-center gap-3 border-2 border-surface-container-low">
 ...
 <Link href="/orders" className="h-20 px-16 bg-jumia-orange text-white rounded-3xl font-semibold text-[10px] uppercase  hover:bg-jumia-orange-dark transition-all shadow-2xl flex items-center justify-center gap-4 mx-auto w-fit">
 Explore History <ArrowRight size={20} />
 </Link>
 </div>
 ) : (
 <div className="bg-surface-container-lowest rounded border border-surface-container-low shadow-soft overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-700">
 ...
 <span className="text-on-surface-variant/40 text-[10px] font-semibold uppercase  italic">
