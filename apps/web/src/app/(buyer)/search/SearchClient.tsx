// apps/web/src/app/(buyer)/search/SearchClient.tsx
'use client';
...
function SearchResults() {
  ...
  const FilterContent = () => (
    <div className="p-5 space-y-6 bg-white">
      <div>
        <h4 className="text-[10px] font-black uppercase text-j-text-muted mb-4 tracking-wider">Price Range (₦)</h4>
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-full bg-j-background border border-j-border rounded-sm px-3 py-2 text-[11px] font-black text-j-text-muted">
              Min: ₦0
            </div>
          ...
          <button 
            onClick={() => updateFilters({ minPrice: '0', maxPrice })}
