...
export default function BestSellersPage() {
 ...
 <p className="text-[10px] font-semibold uppercase tracking-[0.4em] text-on-surface-variant opacity-40 animate-pulse">Calculating Market Velocity</p>
 </div>
 </div>
 );
 }
 ...
 <span className="text-[10px] font-semibold uppercase tracking-[0.3em] text-white">Market Velocity</span>
 </div>
 <div className="flex items-center gap-3 bg-white/5 backdrop-blur-2xl px-6 py-3 rounded-2xl border-2 border-white/10 transition-all hover:bg-white/10 shadow-2xl">
 <Truck size={18} className="text-jumia-orange" />
 <span className="text-[10px] font-semibold uppercase tracking-[0.3em] text-white">Priority Dispatch</span>
 </div>
 </div>
 ...
 <div className="inline-flex items-center gap-4 bg-jumia-orange text-white px-8 py-4 rounded-2xl font-semibold text-[10px] uppercase tracking-[0.4em] shadow-xl shadow-primary-container/20">
 ...
 <h2 className="text-[10px] font-semibold text-jumia-orange uppercase tracking-[0.4em]">Intelligence Report</h2>
 </div>
