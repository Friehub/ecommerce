...
export default async function ProductsPage({
 ...
 <div className="absolute inset-0 bg-jumia-orange opacity-0 group-hover:opacity-5 transition-opacity z-10" />
 {product.media[0] ? (
 <img 
 ...
 className="w-14 h-14 bg-jumia-orange text-white rounded-2xl flex items-center justify-center shadow-2xl hover:bg-jumia-orange-dark transition-all active:scale-90 group/btn"
 >
 ...
 <div className="w-24 h-24 bg-surface-container-low rounded flex items-center justify-center mx-auto mb-10 border border-surface-container-low">
