...
export default function SellerProductsHubPage() {
 ...
 className="w-full p-10 bg-surface-container-low border-4 border-surface-container-lowest rounded-[40px] focus:outline-none focus:border-primary-container/20 focus:ring-[24px] focus:ring-primary-container/5 text-[14px] font-black text-on-surface placeholder:font-normal placeholder:text-on-surface-variant/50 tracking-tight transition-all duration-700 resize-none shadow-inner"
 />
 ...
 className="w-full pl-20 pr-10 py-6 bg-surface-container-lowest border-4 border-surface-container-low rounded-[32px] focus:outline-none focus:border-primary-container/20 focus:ring-[16px] focus:ring-primary-container/5 text-[14px] font-black text-on-surface placeholder:font-normal placeholder:text-on-surface-variant/50 tracking-widest transition-all italic shadow-inner uppercase"
 />
 </div>
