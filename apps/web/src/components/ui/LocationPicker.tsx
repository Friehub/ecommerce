...
export default function LocationPicker({ onLocationSelect, initialPos = [6.5244, 3.3792] }: LocationPickerProps) {
 ...
 return (
 <div className="h-[300px] w-full rounded-xl overflow-hidden border border-outline-variant/30 shadow-inner relative z-0">
 <MapContainer 
 center={position} 
 zoom={13} 
 ...
 <div className="absolute bottom-3 left-3 z-[1000] bg-surface-container-lowest/90 backdrop-blur-md px-3 py-1.5 rounded-lg border border-outline-variant/50 text-[10px] font-extrabold uppercase tracking-tight text-on-surface-variant/60 shadow-sm">
