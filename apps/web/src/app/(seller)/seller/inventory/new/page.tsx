            ...
            <div className="relative z-10 space-y-10">
              <div className="space-y-4">
                ...
                <input 
                  ...
                  className="w-full bg-surface-container-low border-4 border-surface-container-lowest rounded-[32px] px-8 py-6 text-xl font-black text-on-surface placeholder:text-on-surface-variant/10 tracking-tight focus:outline-none focus:border-primary-container/20 focus:ring-[24px] focus:ring-primary-container/5 transition-all duration-700 shadow-inner uppercase"
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                <textarea 
                  ...
                  className="w-full bg-surface-container-low border-4 border-surface-container-lowest rounded-[40px] px-8 py-8 text-sm font-black text-on-surface placeholder:text-on-surface-variant/10 tracking-widest focus:outline-none focus:border-primary-container/20 transition-all duration-700 shadow-inner resize-none uppercase"
                />
              </div>
