...
export const TrendingNow = () => {
 ...
 <div className="w-12 h-12 bg-jumia-orange text-white rounded-2xl flex items-center justify-center shadow-lg shadow-primary-container/20 group-hover/trending:scale-110 transition-transform">
 <TrendingUp size={24} />
 </div>
 <div>
 ...
 >
 <div className="w-24 h-24 bg-surface-container-low rounded-full flex items-center justify-center text-on-surface-variant group-hover:bg-jumia-orange-dark group-hover:text-white transition-all duration-500 border border-surface-container-lowest shadow-lg group-hover:shadow-primary-container/30 group-hover:scale-110 group-hover:-translate-y-2">
 <Icon size={40} strokeWidth={1.5} />
 </div>
 <span className="text-[10px] font-semibold uppercase tracking-widest text-on-surface-variant text-center group-hover:text-jumia-orange transition-colors max-w-[100px] leading-tight opacity-80 group-hover:opacity-100">
 {category.name}
 </span>
 </Link>
 );
