...
export default function AdminFraudQueuePage() {
 ...
 <h2 className="text-[10px] font-semibold text-jumia-orange uppercase tracking-[0.4em]">Security Diagnostic</h2>
 </div>
 ...
 <p className="text-[10px] font-semibold text-on-surface-variant/40 uppercase tracking-[0.4em] mt-4 italic">Transactional anomaly detection and manual security review hub.</p>
 </div>
 ...
 <Fingerprint size={18} />
 <span className="text-[10px] font-semibold uppercase tracking-[0.3em]">Sentinel Active</span>
 </div>
 </div>
 </div>
 ...
 className="w-full pl-16 pr-6 h-14 bg-surface-container-lowest border-2 border-surface-container-low rounded-2xl focus:border-jumia-orange text-[10px] font-semibold uppercase tracking-[0.3em] outline-none placeholder:font-normal placeholder:text-on-surface-variant/50 transition-all"
 />
 </div>
 </div>
 ...
 <thead className="bg-surface-container-low/30 text-[9px] font-semibold uppercase tracking-[0.3em] text-on-surface-variant/60 border-b-2 border-surface-container-low">
 <tr>
 ...
 <span className="text-[9px] font-semibold text-on-surface-variant/20 uppercase tracking-[0.2em]">{format(new Date(order.createdAt), 'dd MMM yyyy, HH:mm')}</span>
 </div>
 </td>
 ...
 className="h-14 px-6 bg-success/5 text-success rounded-2xl text-[10px] font-semibold uppercase tracking-[0.3em] border-2 border-success/10 hover:bg-success hover:text-white transition-all active:scale-90"
 >
 ...
 className="h-14 px-6 bg-error/5 text-error rounded-2xl text-[10px] font-semibold uppercase tracking-[0.3em] border-2 border-error/10 hover:bg-error hover:text-white transition-all active:scale-90"
 >
 ...
 <p className="text-on-surface-variant/40 text-[10px] font-semibold uppercase tracking-[0.3em] italic">NO UNRESOLVED SECURITY FLAGS DETECTED WITHIN THE FRAUD PIPELINE.</p>
 </div>
 )}
 </div>
 </div>
 ...
 <p className="text-[10px] font-semibold uppercase tracking-[0.2em] italic opacity-40 max-w-xl">ALL AUDIT ACTIONS ARE CRYPTOGRAPHICALLY SIGNED AND LOGGED TO THE PERMANENT ADMINISTRATIVE LEDGER.</p>
 </div>
 </div>
