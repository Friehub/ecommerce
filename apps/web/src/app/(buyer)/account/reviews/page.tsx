...
export default function UserReviewsPage() {
 ...
 <p className="text-[10px] font-semibold uppercase  text-on-surface-variant/40 italic mb-10">IDENTITY VERIFICATION REQUIRED TO ACCESS FEEDBACK NODES.</p>
 <Link href="/login" className="h-16 px-12 bg-jumia-orange text-white rounded-2xl font-semibold text-[10px] uppercase  hover:bg-jumia-orange-dark transition-all flex items-center justify-center gap-4 mx-auto w-fit shadow-2xl">
 ...
 <p className="text-[10px] font-semibold uppercase  text-on-surface-variant opacity-40 animate-pulse">Syncing Perception Data</p>
 </div>
 </div>
 );
 }
 ...
 {/* Breadcrumbs */}
 <div className="flex items-center gap-4 mb-12 font-semibold text-on-surface-variant/40 text-[10px] uppercase ">
 ...
 <h2 className="text-[10px] font-semibold text-jumia-orange uppercase ">Sentiment Engine</h2>
 </div>
 ...
 <p className="text-[10px] font-semibold text-on-surface-variant/40 uppercase  mt-4 italic">Management of feedback logs and purchase validation metrics.</p>
 </div>
 ...
 className={`pb-8 text-[11px] font-semibold uppercase  transition-all relative whitespace-nowrap ${activeTab === 'pending' ? 'text-jumia-orange' : 'text-on-surface-variant/40 hover:text-on-surface'}`}
 >
 ...
 className={`pb-8 text-[11px] font-semibold uppercase  transition-all relative whitespace-nowrap ${activeTab === 'reviewed' ? 'text-jumia-orange' : 'text-on-surface-variant/40 hover:text-on-surface'}`}
 >
 ...
 <span className="text-[9px] font-semibold text-jumia-orange/40 uppercase ">WAITING PERCEPTION</span>
 </div>
 </div>
 <Link 
 href={`/account/reviews/new?productId=${item.variant?.product?.id}`}
 className="h-16 px-10 bg-jumia-orange text-white rounded-2xl font-semibold text-[10px] uppercase  hover:bg-jumia-orange-dark transition-all active:scale-95 flex items-center gap-4 shrink-0 shadow-2xl group/btn"
 >
 ...
 <p className="text-on-surface-variant/40 text-[10px] font-semibold uppercase  italic px-10 leading-relaxed">ALL RECENT ACQUISITIONS HAVE BEEN SYSTEMICALLY RATED AND CALIBRATED.</p>
 </div>
 )
 ) : (
 reviews && reviews.length > 0 ? (
 reviews.map((review: any, idx: number) => (
 <div key={review.id} className="bg-surface-container-lowest rounded border border-surface-container-low hover:border-jumia-orange/20 transition-all duration-500 shadow-soft p-10 animate-in fade-in slide-in-from-bottom-8 duration-700" style={{ animationDelay: `${idx * 50}ms` }}>
 ...
 <span className="text-[9px] font-semibold text-on-surface-variant/40 uppercase  italic bg-surface-container-low px-4 py-2 rounded-xl">
 ...
 <div className="flex items-center gap-3 text-[10px] font-semibold text-success uppercase ">
 <div className="w-10 h-10 bg-success/5 rounded-xl flex items-center justify-center border-2 border-success/10">
 <ShieldCheck size={20} />
 </div>
 VERIFIED ACQUISITION
 </div>
 <div className="h-10 px-4 bg-surface-container-low text-on-surface-variant/60 rounded-xl flex items-center justify-center text-[9px] font-semibold uppercase  border-2 border-surface-container-low italic">
 ...
 <p className="text-on-surface-variant/40 text-[10px] font-semibold uppercase  italic px-10 leading-relaxed max-w-sm mx-auto">INITIATE ACQUISITIONS AND CALIBRATE PERCEPTIONS TO POPULATE THIS DATASET.</p>
 </div>
 )
 )}
 </div>
