...
function AdminKYCContent() {
 ...
 <p className="text-[10px] font-semibold uppercase tracking-[0.4em] text-on-surface-variant opacity-40 animate-pulse">Syncing Verification Pipeline</p>
 </div>
 </div>
 );
 }
 ...
 <p className="text-[10px] font-semibold text-on-surface-variant/40 uppercase tracking-[0.4em] mt-4 italic">Entity Identity Verification and Artifact Validation Matrix.</p>
 </div>
 </div>
 </div>
 ...
 <span className="text-[10px] font-semibold uppercase tracking-[0.3em] text-on-surface-variant">Pipeline Active: {queue?.length || 0} Entities Awaiting</span>
 </div>
 </div>
 ...
 <div className="bg-surface-container-lowest rounded-[48px] border border-surface-container-low shadow-soft overflow-hidden animate-in fade-in slide-in-from-left-8 duration-1000">
 ...
 <h3 className="text-[10px] font-semibold text-on-surface uppercase tracking-[0.4em]">Pending Registry Sync</h3>
 </div>
 </div>
 ...
 <p className="text-[10px] font-semibold text-on-surface-variant/40 uppercase tracking-[0.4em] mt-6 italic leading-relaxed">ALL VENDOR ENTITIES HAVE BEEN SYSTEMICALLY AUDITED AND CLEARED.</p>
 </div>
 )}
 </div>
 </div>
 ...
 <p className="text-[10px] font-semibold text-on-surface-variant/40 uppercase tracking-[0.4em] italic">Identity: {selectedSeller.id.toUpperCase()}</p>
 ...
 <span className="text-[9px] font-semibold text-jumia-orange uppercase tracking-[0.3em]">PRIORITY ALPHA</span>
 </div>
 </div>
 </div>
 </div>
 ...
 className="h-24 px-12 bg-jumia-orange text-white rounded font-semibold text-[11px] uppercase tracking-[0.5em] hover:bg-jumia-orange-dark transition-all shadow-2xl active:scale-95 disabled:opacity-30 flex items-center gap-6 group/btn shrink-0"
 >
 ...
 <h4 className="text-[10px] font-semibold text-on-surface-variant/60 uppercase tracking-[0.5em] italic">Payload Validation Matrix</h4>
 </div>
 <div className="space-y-10">
 {selectedSeller.documents.map((doc, dIdx) => (
 <div key={doc.id} className="bg-surface-container-low/30 border border-surface-container-low rounded-[48px] p-10 space-y-8 hover:border-jumia-orange/20 transition-all duration-500 group/card animate-in fade-in slide-in-from-bottom-8 duration-700" style={{ animationDelay: `${dIdx * 100}ms` }}>
 ...
 <p className="text-[9px] text-on-surface-variant/40 font-semibold uppercase tracking-[0.3em] italic">Logged: {format(new Date(doc.createdAt), 'dd MMM yyyy').toUpperCase()}</p>
 </div>
 </div>
 <span className={`text-[9px] h-10 px-6 rounded-full flex items-center justify-center font-semibold uppercase tracking-[0.4em] border-2 shadow-xl ${
 ...
 target="_blank" 
 rel="noreferrer"
 className="h-16 px-10 bg-white text-on-surface rounded-2xl text-[10px] font-semibold uppercase tracking-[0.4em] flex items-center gap-4 hover:scale-105 active:scale-95 transition-all shadow-2xl"
 >
 ...
 className="h-20 bg-jumia-orange text-white rounded font-semibold text-[10px] uppercase tracking-[0.4em] hover:bg-success transition-all active:scale-95 disabled:opacity-30 shadow-2xl group/approve"
 >
 ...
 className="h-20 bg-error/5 text-error border border-error/10 rounded font-semibold text-[10px] uppercase tracking-[0.4em] hover:bg-error hover:text-white transition-all active:scale-95 disabled:opacity-30 group/reject"
 >
 ...
 <h4 className="text-[11px] font-semibold text-on-surface uppercase tracking-[0.5em] italic leading-none">Verification Protocols</h4>
 </div>
 ...
 <p className="text-[11px] font-semibold text-jumia-orange uppercase tracking-[0.5em] italic">Systemic Auto-Sync</p>
 </div>
 <p className="text-[13px] font-semibold text-white/40 leading-relaxed uppercase tracking-[0.2em] italic relative z-10">
 ...
 <div className="w-32 h-32 bg-surface-container-low rounded-[48px] flex items-center justify-center text-on-surface-variant/10 mb-12 border border-surface-container-lowest shadow-inner">
 ...
 <p className="text-[10px] text-on-surface-variant/40 font-semibold uppercase tracking-[0.5em] mt-6 max-w-sm italic leading-relaxed">
