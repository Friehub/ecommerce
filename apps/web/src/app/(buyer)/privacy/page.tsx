...
export default function PrivacyTermsPage() {
 ...
 {/* Content Section */}
 <div className="bg-surface-container-lowest rounded-[56px] border border-surface-container-low shadow-soft p-10 md:p-16 space-y-16 select-text animate-in fade-in slide-in-from-bottom-8 duration-1000">
 <section className="space-y-6">
 <div className="flex items-center gap-4 border-b-2 border-surface-container-low pb-6">
 <div className="p-3 bg-surface-container-low rounded-xl text-jumia-orange border-2 border-surface-container-low">
 <Scale size={20} />
 </div>
 <h2 className="text-xl font-semibold text-on-surface tracking-tighter uppercase leading-none">1. Jurisdictional <span className="text-jumia-orange">Terms</span></h2>
 </div>
 <p className="text-[11px] font-semibold text-on-surface-variant/60 leading-relaxed uppercase tracking-widest italic pl-16">
 ...
 <h2 className="text-xl font-semibold text-on-surface tracking-tighter uppercase leading-none">2. Identity & <span className="text-jumia-orange">Data Integrity</span></h2>
 </div>
 <p className="text-[11px] font-semibold text-on-surface-variant/60 leading-relaxed uppercase tracking-widest italic pl-16">
 ...
 <h2 className="text-xl font-semibold text-on-surface tracking-tighter uppercase leading-none">3. Secure <span className="text-jumia-orange">Settlements</span></h2>
 </div>
 <p className="text-[11px] font-semibold text-on-surface-variant/60 leading-relaxed uppercase tracking-widest italic pl-16">
