...
export function NotificationInbox() {
 ...
 const getIcon = (type: string) => {
    ...
    return <div className="w-8 h-8 bg-primary-container/5 rounded-xl flex items-center justify-center border border-primary-container/10"><Info size={16} className="text-primary-container" /></div>;
  };
