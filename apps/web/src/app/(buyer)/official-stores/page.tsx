    ...
    <div className="bg-[#F5F5F5] min-h-screen pb-12">
      <div className="container py-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-xs font-bold text-gray-900">Official Stores</span>
        </div>

        <div className="bg-white rounded shadow-sm overflow-hidden">
          <div className="bg-[#48A44C] p-4 text-white flex items-center gap-3">
            <ShieldCheck size={24} />
            <h1 className="text-xl font-bold uppercase tracking-tight">Official Stores</h1>
          </div>
          ...
          <div className="p-20 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Authentic Brands Only</h2>
            <p className="text-gray-500 mt-2 mb-8">Shop directly from the brands you love with 100% authenticity guaranteed.</p>
