...
export default function NotificationsPage() {
 ...
 <h1 className="text-xl font-semibold text-on-surface uppercase tracking-tighter">Signal Center</h1>
 </div>
 <button 
 onClick={markAllAsRead}
 className="text-[9px] font-semibold text-jumia-orange hover:bg-jumia-orange-dark hover:text-white px-5 py-2.5 border-2 border-jumia-orange/20 rounded-xl transition-all uppercase tracking-widest active:scale-95 italic"
 >
 Sync All Feeds
 </button>
 </div>
