          ...
          <div className="flex flex-col lg:flex-row p-5 lg:p-7 gap-8">
              ...
              <div className="flex justify-between items-start">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <span className="bg-orange-50 border border-orange-200 text-[#F68B1E] text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wide">
                      Official Store
                    </span>
                    <p className="text-xs text-[#264996] font-bold hover:underline cursor-pointer tracking-tight">{product.brand.name}</p>
                  </div>
                  <h1 className="text-xl md:text-2xl font-bold text-gray-900 leading-tight tracking-tight">
                    {product.title}
                  </h1>
                </div>
                <button className="p-2.5 hover:bg-gray-50 border border-transparent rounded-full duration-150 transition-all cursor-pointer group">
            ...
            <div className="w-full lg:w-[280px] hidden lg:block space-y-4">
              <div className="bg-white border border-gray-200 rounded-lg p-5">
                <h4 className="text-xs font-bold uppercase text-gray-500 mb-3 tracking-wide">Delivery & Returns</h4>
                <div className="space-y-4">
                  <div className="flex gap-3 items-center">
                    <div className="text-[#F68B1E] bg-orange-50 p-2 rounded border border-orange-200">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                    </div>
                    <div>
                      <p className="text-xs font-bold text-gray-800">Lagos, Ikeja</p>
                      <p className="text-[10px] font-medium text-[#F68B1E] cursor-pointer hover:underline">Change location</p>
                    </div>
                  </div>
                  <div className="bg-blue-50 border border-blue-200 p-3 rounded text-[11px] text-[#264996] font-medium leading-relaxed">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-5">
                <h4 className="text-xs font-bold uppercase text-gray-500 mb-3 tracking-wide">Seller Information</h4>
                <div className="space-y-1 pb-2">
                  <p className="text-sm font-bold text-gray-800">{product.seller.businessName || "Jumia Store"}</p>
                ...
                <button className="w-full mt-3 text-[#F68B1E] border border-orange-200 bg-orange-50 hover:bg-[#F68B1E] hover:text-white py-2 rounded text-xs font-bold uppercase duration-150 transition-all tracking-wide select-none">
                  Follow
                </button>
              </div>
            </div>
