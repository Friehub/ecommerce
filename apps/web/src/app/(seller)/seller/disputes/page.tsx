...
export default function SellerDisputesPage() {
 ...
 <span className="text-[10px] font-semibold uppercase tracking-[0.5em] text-jumia-orange italic">Neural Mediation Nexus & Dispute Resolution Center</span>
 </div>
 ...
 <p className="text-on-surface-variant text-[10px] font-semibold uppercase tracking-[0.4em] mt-8 opacity-40 italic border-l-4 border-jumia-orange pl-8">Professional Consumer Protection & Automated Mediation Control</p>
 </div>
 ...
 <div>
 <h3 className="text-sm font-semibold text-on-surface uppercase tracking-[0.4em] leading-none mb-2">Dispute Matrix</h3>
 <p className="text-[9px] font-semibold text-on-surface-variant/40 uppercase tracking-[0.2em] italic">Active Operational Mediation Ledger</p>
 </div>
 </div>
 ...
 <span className="text-[9px] font-semibold uppercase text-on-surface-variant tracking-[0.3em] italic opacity-60">System Synchronized</span>
 </div>
 </div>
 ...
 <span className={`text-[9px] px-6 py-2 rounded-full font-semibold uppercase tracking-[0.4em] border-2 shadow-sm italic transition-all duration-700 ${
 dispute.status === 'OPEN' 
 ...
 <div className="flex items-center gap-6 text-[10px] text-on-surface-variant/30 font-semibold uppercase tracking-[0.3em] italic">
 ...
 <div className="w-32 h-32 bg-surface-container-low rounded-[48px] flex items-center justify-center mx-auto mb-12 border border-surface-container-lowest text-on-surface-variant shadow-inner group">
 ...
 <p className="text-on-surface-variant text-[11px] font-semibold uppercase tracking-[0.4em] max-w-sm mx-auto italic leading-relaxed">
